...
class Player:
    ...
    def update(self):
        ...
        # Estos seis ifs son los que nos ayudan a que pacman no pase por en medio
        # de las líneas del grid
        if  self.time_to_move():
            if self.stored_direction != None:
                self.direction = self.stored_direction                      
            self.able_to_move = self.can_move()
        # Aqui se setea la posición en el grid con respecto a la posición en pixeles
    ...
    def draw(self):
        ...
        # Aqui se dibuja el rectángulo rojo de la posicion cuando se tiene el grid
